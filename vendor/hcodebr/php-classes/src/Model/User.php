...
class User extends Model{
	...
	public static function verifyLogin($inadim = true){
		...
		if(
			...
			||
			(bool)$_SESSION[User::SESSION]["iduser"] !== $inadim
	...
	public function update(){
		...
		$results=$sql->select("CALL sp_usersupdate_save(:iduser,:desperson, :deslogin, :despassword, :desemail, :nrphone, :inadim)", array(
